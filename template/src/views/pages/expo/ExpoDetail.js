  ...
  return (
    <div style={{
      ...
      <CContainer fluid style={{
        ...
        {/* Hero */}
        <CRow className="mb-4">
          <CCol xs={12} lg={7} className="mb-4 mb-lg-0">
            <CCard style={{
              border: 'none',
              borderRadius: '25px',
              background: `linear-gradient(135deg, #ffa749ff   0%,   #20de3dff 90%)`,
              overflow: 'hidden',
              position: 'relative',
              ...
              <CCardBody style={{ padding: '3rem', position: 'relative', zIndex: 3 }}>
                ...
                {expo.theme && (
                  <div style={{
                    ...
                    <p style={{ fontSize: '1.1rem', color: '#1d1e1eff', marginBottom: 0, fontWeight: 500 }}>
                ...
                <div className="row g-4 mb-4">
                  <div className="col-md-6">
                    <div style={{
                      ...
                      <div className="d-flex align-items-center">
                        <div style={{ background: '#000000ff', borderRadius: '12px', padding: '0.8rem', marginRight: '1rem' }}>
                          <CIcon icon={cilCalendar} style={{ color: 'white', fontSize: '1.3rem' }} />
                        </div>
                        <div>
                          <div style={{ fontWeight: 700, color: '#1d1e1eff', fontSize: '1.1rem' }}>
                            {formatDate(expo.date)}
                          </div>
                          <div style={{ fontSize: '0.9rem', color: '#656c76ff', fontWeight: 500, }}>
                            {getCountdownText()}
                          </div>
                        </div>
                      </div>
                    ...
                    <div style={{
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: '0.9rem', color: '#6e7885ff', fontWeight: 500, }}>
                ...
                {daysUntil != null && daysUntil > 0 && (
                  <div style={{
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                      <span style={{ fontSize: '1rem', fontWeight: 700, color: '#2d3035ff' }}>
                        <CIcon icon={cilClock} className="me-2" />
                        Event Countdown
                      </span>
                      <span style={{ fontSize: '0.9rem', color: '#ca3486ff', fontWeight: 600 }}>
          ...
          <CCol xs={12} lg={5}>
            <CCard style={{
              ...
              <CCardHeader style={{
                background: 'linear-gradient(135deg, #cd1414ff 0%, #976cedff 130%)',
                border: 'none',
                color: 'white',
              ...
              <CCardBody style={{ padding: '1.5rem' }}>
                <div className="d-grid gap-3">
                  <div className="text-center p-3" style={{
                    ...
                    <div style={{ fontSize: '2.5rem', color: '#070707ff', fontWeight: 900, position: 'relative', zIndex: 2 }}>
                      {expo.floors ?? 0}
                    </div>
                    <div style={{ fontSize: '0.95rem', color: '#070707ff', fontWeight: 600 }}>
                      Exhibition Floors
                    </div>
                  </div>
                  ...
                  <div className="text-center p-3" style={{
                    ...
                    <div style={{ fontSize: '0.95rem', color: '#191a1bff', fontWeight: 600 }}>
                      Industry Focus
                    </div>
                  </div>
                  ...
                  <div className="text-center p-3" style={{
                    ...
                    <div style={{ fontSize: '0.95rem', color: '#222427ff', fontWeight: 600 }}>
                      Verified Event
                    </div>
                  </div>
                  ...
                  <div className="text-center p-3" style={{
                    ...
                    <div style={{ fontSize: '0.95rem', color: '#1a1b1cff', fontWeight: 600 }}>
                      Scheduled Events
                    </div>
                  </div>
                </div>
        ...
        <CRow className="mb-4">
          <CCol xs={12}>
            <CCard style={{
              ...
              background: 'linear-gradient(135deg, #ec2121ff 0%, #e42f6bff 100%)',
              backdropFilter: 'blur(10px)'
            }}>
              <CCardBody style={{ padding: '1.5rem' }}>
                  ...
                  <CNavItem>
                    <CNavLink
                      ...
                      style={{
                        ...
                        background:
                          activeTab === 'overview'
                            ? 'linear-gradient(135deg, green, orange)'
                            : 'transparent',
                        color: activeTab === 'overview' ? 'white' : '#000000ff',
                        border: 'none',
                  ...
                  <CNavItem>
                    <CNavLink
                      ...
                      style={{
                        ...
                        padding: '0.75rem 1.5rem',
                        fontWeight: 600,
                        background: activeTab === 'schedule' ? 'linear-gradient(135deg, green, orange)' : 'transparent',
                        color: activeTab === 'schedule' ? 'white' : '#040404ff',
                        border: 'none',
                        transition: 'all 0.3s ease'
                      }}
                    >
                  ...
                  <CNavItem>
                    <CNavLink
                      ...
                      style={{
                        ...
                        padding: '0.75rem 1.5rem',
                        fontWeight: 600,
                        background: activeTab === 'details' ? 'linear-gradient(135deg, green, orange)' : 'transparent',
                        color: activeTab === 'details' ? 'white' : '#0a0a0aff',
                        border: 'none',
                        transition: 'all 0.3s ease'
                      }}
                    >
        ...
        <CTabContent>
          ...
          <CTabPane visible={activeTab === 'overview'}>
            <CRow>
              <CCol lg={8}>
                {expo.description && (
                  <CCard style={{
                    ...
                    <CCardHeader style={{
                      background: 'linear-gradient(135deg, #368a0dff 0%, #c5ad58ff 100%)',
                      border: 'none',
                      color: 'white',
                      borderRadius: '20px 20px 0 0',
                      fontWeight: 700,
                ...
                {expo.attachment && (
                  <CCard style={{
                    ...
                    <CCardBody style={{ padding: '2rem' }}>
                      <div style={{ position: 'relative', overflow: 'hidden', borderRadius: '15px', justifyContent: 'center' }}>
                        <img
                        ...
                        >
                          <CCardHeader
                            style={{
                              background: "linear-gradient(135deg, #368a0d 0%, #c5ad58 100%)",
                              border: "none",
                          ...
                          <CCardBody style={{ padding: "1rem" }}>
                            <CListGroup flush>
                              ...
                              >
                                <span style={{ color: "#000000ff", fontSize: "0.9rem", fontWeight: 500 }}>
                                  Status
                                </span>
                                <CBadge
                                  style={{
                              ...
                              >
                                ...
                                <span style={{ fontWeight: 500, fontSize: "0.9rem", color: "#1e293b" }}>
                                  {new Date(expo.date).toLocaleDateString() || "TBA"}
                                </span>
                              </CListGroupItem>
              ...
              {/* Event Section as attendee or administrator */}
                  ...
                  <CCardBody style={{ padding: '2rem' }}>
                    <div className="d-grid gap-3">
                      <div style={{
                        ...
                        <h6 style={{ fontWeight: 700, color: '#3b1e1eff', marginBottom: '0.5rem' }}>
                          Join as Attendee
                        </h6>
                        <p style={{ color: '#646d78ff', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
                          Browse exhibitions, attend sessions, and network with professionals
                        </p>
                        <CButton
                          onClick={() => handleRegistration('Attendee')}
                          style={{
                            background: 'linear-gradient(135deg, #f93636ff 0%, #9817a7ff 120%)',
                            border: 'none',
                            borderRadius: '12px',
                            padding: '0.75rem 1.5rem',
                            fontSize: '0.95rem',
                      ...
                      <CButton
                        style={{
                          ...
                          fontSize: "1rem",
                          fontWeight: 600,
                          background: "linear-gradient(135deg, #f93636ff 0%, #a01de1ff  120%)",
                          border: "none",
                          color: "#fff",
                          transition: "all 0.3s ease",
                        }}
                        onMouseEnter={(e) => {
                          e.target.style.background =
                            "linear-gradient(135deg, #840c0cff 0%, #a01de1ff 100%)";
                        }}
                      >
                        Contact Organizer
                      </CButton>
            ...
            <CRow>
              <CCol>
                <CCard style={{
                  ...
                  <CCardHeader style={{
                    background: 'linear-gradient(135deg, green 0%, orange 130%)',
                    border: 'none',
                    borderRadius: '20px 20px 0 0',
                    fontWeight: 700,
                    fontSize: '1.2rem',
                      ...
                      <div className="d-flex gap-2">
                        {['all', 'today', 'upcoming', 'past'].map((filter) => (
                          <CButton
                            key={filter}
                            size="sm"
                            color={scheduleFilter === filter ? 'danger' : 'light'}
                      ...
                      <div>
                        {Object.entries(groupedSchedules).map(([date, dayList], idx, arr) => (
                          <div key={date} style={{ marginBottom: idx < arr.length - 1 ? '3rem' : 0 }}>
                            <div style={{
                              background: 'linear-gradient(135deg, #f91616ff, #f50b61ff 100%)',
                              color: 'black',
                              padding: '1rem 1.5rem',
                              borderRadius: '12px',
                              marginBottom: '1.5rem',
                              ...
                              fontWeight: 700,
                              fontSize: '1.1rem',
                              boxShadow: `0 4px 15px #ffffffff 30`
                            }}>
                            ...
                            <div style={{
                              ...
                              <CTable responsive hover style={{ margin: 0 }}>
                                <CTableHead>
                                  <CTableRow style={{ background: '' }}>
                                    <CTableHeaderCell style={{ border: 'none', padding: '1rem', fontWeight: 700, color: '' }}>
                                      Time
                                    </CTableHeaderCell>
                                    <CTableHeaderCell style={{ border: 'none', padding: '1rem', fontWeight: 700, color: '' }}>
                                      Event
                                ...
                                <CTableBody>
                                  {sortedByTime(dayList).map((s, i) => (
                                    <CTableRow
                                      key={s._id || i}
                                      style={{ borderLeft: `4px solid #FFFFFF `, transition: 'all 0.3s ease' }}
                                      onMouseEnter={(e) => {
                                        e.currentTarget.style.background = `#FFFFFF 08`
                                    ...
                                    >
                                      <CTableDataCell style={{ border: 'none', padding: '1.2rem 1rem' }}>
                                        <div style={{
                                          ...
                                          <div style={{ fontSize: '0.9rem', fontWeight: 700, color: '#ffffffff' }}>
                                            {formatTime(s.startTime)}
                                          </div>
                                          <div style={{ fontSize: '0.8rem', color: '#ffffffff' }}>
                                            {formatTime(s.endTime)}
                                          </div>
                                        </div>
                                      </CTableDataCell>
                                      <CTableDataCell style={{ border: 'none', padding: '1.2rem 1rem' }}>
                                        <h6 style={{ fontWeight: 700, color: '#ffffffff', marginBottom: '0.3rem', fontSize: '1rem' }}>
                                        ...
                                        {s.speaker ? (
                                          <div className="d-flex align-items-center">
                                            <div style={{
                                              ...
                                              <CIcon icon={cilUser} style={{ color: '#ffffffff', fontSize: '0.9rem' }} />
                                            </div>
                                            <div>
                                              <div style={{ fontWeight: 600, color: '#ffffffff', fontSize: '0.9rem' }}>
                                                {s.speaker}
                                              </div>
                                              <div style={{ fontSize: '0.8rem', color: '#ffffffff' }}>Speaker</div>
                                            </div>
                                          </div>
                                        ) : (
                                          <span style={{ color: '#ffffffff', fontStyle: 'italic' }}>TBA</span>
                                        )}
                                      </CTableDataCell>
                                      <CTableDataCell style={{ border: 'none', padding: '1.2rem 1rem' }}>
                                        {s.description ? (
                                          <p style={{ color: '#ffffffff', fontSize: '0.9rem', lineHeight: 1.5, marginBottom: 0, maxWidth: '250px' }}>
                                            {s.description.length > 100 ? `${s.description.substring(0, 100)}…` : s.description}
                                          </p>
                                        ) : (
                                          <span style={{ color: '#ffffffff', fontStyle: 'italic' }}>No description available</span>
                                        )}
                                      </CTableDataCell>
                                    </CTableRow>
                                  ))}
                ...
                <CCard style={{
                  ...
                  <CCardBody style={{ padding: '2rem' }}>
                    <div className="row g-4">
                      <div className="col-md-6">
                        <div style={{
                          background: 'linear-gradient(135deg, #94cc51ff 0%, #f0823dff 120%)',
                          borderRadius: '15px',
                          padding: '1.5rem',
                          border: '1px solid #e2e8f0'
                        }}>
                          <div className="d-flex align-items-center mb-3">
                            <div style={{ background: 'green', borderRadius: '8px', padding: '0.5rem', marginRight: '0.75rem' }}>
                              <CIcon icon={cilCalendar} style={{ color: 'white' }} />
                            </div>
                            <h6 style={{ margin: 0, fontWeight: 700, color: '#ffffffff' }}>Event Date</h6>
                          </div>
                          <p style={{ color: '#ffffffff', marginBottom: 0 }}>{formatDate(expo.date)}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div style={{
                          ...
                          <div className="d-flex align-items-center mb-3">
                            ...
                            <h6 style={{ margin: 0, fontWeight: 700, color: '#fafcffff' }}>Location</h6>
                          </div>
                          <p style={{ color: '#ffffffff', marginBottom: 0 }}>{expo.location || 'TBA'}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div style={{
                          ...
                          <div className="d-flex align-items-center mb-3">
                            ...
                            <h6 style={{ margin: 0, fontWeight: 700, color: '#ffffffff' }}>Exhibition Floors</h6>
                          </div>
                          <p style={{ color: '#ffffffff', marginBottom: 0 }}>{expo.floors ?? 0} Floor{(expo.floors || 0) > 1 ? 's' : ''}</p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div style={{
                          ...
                          <div className="d-flex align-items-center mb-3">
                            ...
                            <h6 style={{ margin: 0, fontWeight: 700, color: '#ffffffff' }}>Event Duration</h6>
                          </div>
                          <p style={{ color: '#ffffffff', marginBottom: 0 }}>
        ...
        <CCard className="mb-4" style={{
          ...
          <CCardHeader style={{
            background: 'linear-gradient(135deg, #4a8408ff 0%, #f9d03cff 130%)',
            border: 'none',
            borderRadius: '20px 20px 0 0',
            fontWeight: 700,
            fontSize: '1.1rem',
            ...
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
              <div>
                <h5 className="mb-0 text-white">Booths in this Expo</h5>
              ...
              <div className="input-group" style={{ maxWidth: 320 }}>
                ...
                <input
                  type="text"
                  className="form-control bg-success border-start-0"
          ...
          <CCardBody style={{ background: '#fff', overflowX: 'auto' }}>
            <CTable hover responsive style={{ minWidth: 700, borderRadius: '12px', overflow: 'hidden' }}>
              <CTableHead>
                <CTableRow style={{ background: '#e0e7ff' }}>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Booth_#</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Floor</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Size</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Status</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Price</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Features</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Notes</CTableHeaderCell>
                  <CTableHeaderCell style={{ fontWeight: 700, color: '#ffffffff', padding: '1rem' }}>Exhibitor</CTableHeaderCell>
                </CTableRow>
              </CTableHead>
              <CTableBody>
                  ...
                  >
                    ...
                    <CTableDataCell style={{ padding: '1rem' }}>
                      <div className="d-flex flex-wrap gap-2">
                        {booth.has_power && (
                          <CBadge color="info">
                            <CIcon icon={cilBolt} className="me-1" /> Power
                          </CBadge>
                        )}
                        {booth.has_wifi && (
                          <CBadge color="info">
                            <CIcon icon={cilWifiSignal4} className="me-1" /> WiFi
                          </CBadge>
                        )}
                        {booth.is_corner_booth && (
                          <CBadge color="warning">
                            <CIcon icon={cilLocationPin} className="me-1" /> Corner
                          </CBadge>
                        )}
                        {!booth.has_power && !booth.has_wifi && !booth.is_corner_booth && (
